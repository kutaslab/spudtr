...
def OpenFile():
    ...
    f_eeg = tkinter.filedialog.askopenfilename(
        parent=root, initialdir=DATA_DIR,
        title='Choose file',
...
b1 = tkinter.Button(root, text='Select a eeg file',
        height = 3, width = 20,
        font=helv16,
        command=OpenFile)
b1.pack(fill='x')
b2 = tkinter.Button(root, text='Select a config yaml file',
        height = 3, width = 20,
        font=helv16,
...
button = tkinter.Button(root, text = "Create epochs plot", 
        height = 3, width = 20,
        font=helv16,
